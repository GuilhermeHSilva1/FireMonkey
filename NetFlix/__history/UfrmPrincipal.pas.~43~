...
begin
  ...
  with Self do
    begin
      SetupMenu(TListBoxItem.Create(ListBox1), 'Todos os gêneros');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Disponível para download');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Ação');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Adolescente');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Anime');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Asiáticos');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Brasileiros');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Comédia');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Drama');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Esportes');
      SetupMenu(TListBoxItem.Create(ListBox1), 'Mistério');
